...
export default function Addproduct(props) {
  ...
  const { changeTheme, display, activeuser, setactiveuser } =
  ...
  const addItem = (e) => {
    ...
    axios
      .post(
        `https://safehomefurniture.onrender.com/api/admin/${user?.[0].data.data._id}`,
        formData,
        {
          headers: {
  ...
  return (
    <div className="newlink">
      ...
      <div className="newlink_wrap">
            ...
            <div className="newlink_left_top">
              ...
              <div className="newlink_left_top_image">
                ...
                <span className="newlink_left_top_image_text">
                  <h3>Upload Link Image</h3>
                  <p>
                    Recommended size - 512px X 512px Fomart - JPG or PNG, under
                    1MB in size.
                  </p>
                </span>
              </div>
        ...
        {loader && (
          <div className="loader_newlink_right">
